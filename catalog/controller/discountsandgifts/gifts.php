...
class ControllerDiscountsAndGiftsGifts extends Controller {
	...
	public function index(){
		...
		$categories_id = $this->model_tool_discounts_and_gifts->getGiftsId();
		...
		$this->response->setOutput($this->load->view('discounts_and_gifts/gifts', $data));
	}
