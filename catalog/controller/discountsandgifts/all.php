...
class ControllerDiscountsAndGiftsAll extends Controller {
	...
	public function index(){
		...
		$categories_id = $this->model_tool_discounts_and_gifts->getAllId();
		...
		$this->response->setOutput($this->load->view('discounts_and_gifts/all_discounts_and_gifts', $data));
	}
